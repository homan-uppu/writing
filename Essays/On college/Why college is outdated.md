...
But as technological leverage increased, which it did quickly in software engineering, these software consulting services have faced a crunch.

(TODO: look at the economics of software consulting as a space).
...
For companies, the value proposition was access to a high quality pool of candidates. Software engineers are incredibly valuable assets for companies, and companies fought hard to get the best ones.

Triplebyte made money by charging companies that hired their candidates a percentage of the candidates salary for 2 years. This business model aligned incentives: if Triplebyte could efficiently identify great talent, companies would be happy to pay.
...
I'd already witnessed a similar sort of market in India around IIT-JEE prep. IIT is India's premier technical university. By succeeding on this exam, you'd get entry into a top college at an affordable rate. As you can imagine, the competition is fierce, and a massive exam prep market exists as a result.
...
Similarly, the open secret in Tech is that the software engineer interview doesn't identify top talent. The best it does is eliminates candidates who are outright lying saying that they know how to code. So it's useful to the extent that it filters out the worst candidates, but by itself it can't identify the best talent.

Eventually, Triplebyte failed. On Hackernews (a technology / startup community) (https://news.ycombinator.com/item?id=35184546), the head of product at Triplebyte graciously discussed why the company didn't succeed:
...
### Why college is tough to displace

If the creativity bar is rising, and a standardized education like college won't train you to be useful, then why are people still enrolling in colleges in droves? Why is college still the primary path for most young people?
...
Items that were aspirational to previous generations were quickly tossed aside by later generations that no longer saw them as valuable.

So if there really was a great college alternative that had a track record of excellent results, it would be massively successful. Who wouldn't go to an institution that has an incredible track record for success?
...
As a result, outside a few domains (those that are regulated), there are no low-risk learning paths available.
...
### Why do elite colleges still work?

- Scarcity 
### Misaligned Incentives
- Can colleges make the shift to training minds that can thrive in a world with a high bar for creativity? At scale? I don't think it's possible due to an incentive problem.
